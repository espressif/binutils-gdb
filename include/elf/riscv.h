...
#define R_RISCV_DELETE_AND_RELAX  (R_RISCV_internal_first + 1)
#define R_RISCV_RVC_LUI           (R_RISCV_internal_first + 2)
#define R_RISCV_GPREL_I           (R_RISCV_internal_first + 3)
#define R_RISCV_GPREL_S           (R_RISCV_internal_first + 4)
#define R_RISCV_TPREL_I           (R_RISCV_internal_first + 5)
#define R_RISCV_TPREL_S           (R_RISCV_internal_first + 6)
