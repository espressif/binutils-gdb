...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_ESP_LP_OFFSET_9_OLD, 66)
  RELOC_NUMBER (R_RISCV_ESP_LP_OFFSET_12_OLD, 67)
...
#define R_RISCV_internal_first (R_RISCV_ESP_LP_OFFSET_12_OLD + 1)
...
START_RELOC_NUMBERS (elf_riscv_esp_reloc_type)
  RELOC_NUMBER (R_RISCV_ESP_LP_OFFSET_9_NEW, 192)
  RELOC_NUMBER (R_RISCV_ESP_LP_OFFSET_12_NEW, 193)
