...
START_RELOC_NUMBERS (elf_esp32ulp_reloc_type)
	...
	RELOC_NUMBER(R_ESP32S2ULP_STAGE, 0x28)

	RELOC_NUMBER(R_ESP32S2ULP_JUMPR_STEP, 0x29)
	RELOC_NUMBER(R_ESP32S2ULP_JUMPR_THRESH, 0x2A)
	RELOC_NUMBER(R_ESP32S2ULP_JUMPS_THRESH, 0x2B)

	RELOC_NUMBER(R_ESP32S2ULP_REG_RW_HIGH, 0x2C)
	RELOC_NUMBER(R_ESP32S2ULP_REG_RW_LOW, 0x2D)
	RELOC_NUMBER(R_ESP32S2ULP_REG_RW_ADDR, 0x2E)
	RELOC_NUMBER(R_ESP32S2ULP_REG_RW_DATA, 0x2F)

	RELOC_NUMBER(R_ESP32S2ULP_I2C_RW_HIGH, 0x30)
	RELOC_NUMBER(R_ESP32S2ULP_I2C_RW_LOW, 0x31)
	RELOC_NUMBER(R_ESP32S2ULP_I2C_RW_ADDR, 0x32)
	RELOC_NUMBER(R_ESP32S2ULP_I2C_RW_DATA, 0x33)
	RELOC_NUMBER(R_ESP32S2ULP_I2C_RW_SEL, 0x34)

	RELOC_NUMBER(R_ESP32S2ULP_WR_MEM_LABEL, 0x35)

	RELOC_NUMBER(R_ESP32ULP_RESERVE, 0x36)
