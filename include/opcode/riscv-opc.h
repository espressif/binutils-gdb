...
/* Vendor-specific (Espressif) XESP* instructions.  */
#if RISCV_XESPV2P1
...
#if RISCV_XESPV2P1
/* XESPV instructions. */
DECLARE_INSN(esp_addx2, MATCH_ESP_ADDX2, MASK_ESP_ADDX2)
DECLARE_INSN(esp_addx4, MATCH_ESP_ADDX4, MASK_ESP_ADDX4)
DECLARE_INSN(esp_andq, MATCH_ESP_ANDQ, MASK_ESP_ANDQ)
DECLARE_INSN(esp_cmul_s16, MATCH_ESP_CMUL_S16, MASK_ESP_CMUL_S16)
DECLARE_INSN(esp_cmul_s16_ld_incp, MATCH_ESP_CMUL_S16_LD_INCP, MASK_ESP_CMUL_S16_LD_INCP)
DECLARE_INSN(esp_cmul_s16_st_incp, MATCH_ESP_CMUL_S16_ST_INCP, MASK_ESP_CMUL_S16_ST_INCP)
DECLARE_INSN(esp_cmul_s8, MATCH_ESP_CMUL_S8, MASK_ESP_CMUL_S8)
DECLARE_INSN(esp_cmul_s8_ld_incp, MATCH_ESP_CMUL_S8_LD_INCP, MASK_ESP_CMUL_S8_LD_INCP)
DECLARE_INSN(esp_cmul_s8_st_incp, MATCH_ESP_CMUL_S8_ST_INCP, MASK_ESP_CMUL_S8_ST_INCP)
DECLARE_INSN(esp_cmul_u16, MATCH_ESP_CMUL_U16, MASK_ESP_CMUL_U16)
DECLARE_INSN(esp_cmul_u16_ld_incp, MATCH_ESP_CMUL_U16_LD_INCP, MASK_ESP_CMUL_U16_LD_INCP)
DECLARE_INSN(esp_cmul_u16_st_incp, MATCH_ESP_CMUL_U16_ST_INCP, MASK_ESP_CMUL_U16_ST_INCP)
DECLARE_INSN(esp_cmul_u8, MATCH_ESP_CMUL_U8, MASK_ESP_CMUL_U8)
DECLARE_INSN(esp_cmul_u8_ld_incp, MATCH_ESP_CMUL_U8_LD_INCP, MASK_ESP_CMUL_U8_LD_INCP)
DECLARE_INSN(esp_cmul_u8_st_incp, MATCH_ESP_CMUL_U8_ST_INCP, MASK_ESP_CMUL_U8_ST_INCP)
DECLARE_INSN(esp_fft_ams_s16_ld_incp, MATCH_ESP_FFT_AMS_S16_LD_INCP, MASK_ESP_FFT_AMS_S16_LD_INCP)
DECLARE_INSN(esp_fft_ams_s16_ld_incp_uaup, MATCH_ESP_FFT_AMS_S16_LD_INCP_UAUP, MASK_ESP_FFT_AMS_S16_LD_INCP_UAUP)
DECLARE_INSN(esp_fft_ams_s16_ld_r32_decp, MATCH_ESP_FFT_AMS_S16_LD_R32_DECP, MASK_ESP_FFT_AMS_S16_LD_R32_DECP)
DECLARE_INSN(esp_fft_ams_s16_st_incp, MATCH_ESP_FFT_AMS_S16_ST_INCP, MASK_ESP_FFT_AMS_S16_ST_INCP)
DECLARE_INSN(esp_fft_bitrev, MATCH_ESP_FFT_BITREV, MASK_ESP_FFT_BITREV)
DECLARE_INSN(esp_fft_cmul_s16_ld_xp, MATCH_ESP_FFT_CMUL_S16_LD_XP, MASK_ESP_FFT_CMUL_S16_LD_XP)
DECLARE_INSN(esp_fft_cmul_s16_st_xp, MATCH_ESP_FFT_CMUL_S16_ST_XP, MASK_ESP_FFT_CMUL_S16_ST_XP)
DECLARE_INSN(esp_fft_r2bf_s16, MATCH_ESP_FFT_R2BF_S16, MASK_ESP_FFT_R2BF_S16)
DECLARE_INSN(esp_fft_r2bf_s16_st_incp, MATCH_ESP_FFT_R2BF_S16_ST_INCP, MASK_ESP_FFT_R2BF_S16_ST_INCP)
DECLARE_INSN(esp_fft_vst_r32_decp, MATCH_ESP_FFT_VST_R32_DECP, MASK_ESP_FFT_VST_R32_DECP)
DECLARE_INSN(esp_ld_128_usar_ip, MATCH_ESP_LD_128_USAR_IP, MASK_ESP_LD_128_USAR_IP)
DECLARE_INSN(esp_ld_128_usar_xp, MATCH_ESP_LD_128_USAR_XP, MASK_ESP_LD_128_USAR_XP)
DECLARE_INSN(esp_ld_qacc_h_h_128_ip, MATCH_ESP_LD_QACC_H_H_128_IP, MASK_ESP_LD_QACC_H_H_128_IP)
DECLARE_INSN(esp_ld_qacc_h_l_128_ip, MATCH_ESP_LD_QACC_H_L_128_IP, MASK_ESP_LD_QACC_H_L_128_IP)
DECLARE_INSN(esp_ld_qacc_l_h_128_ip, MATCH_ESP_LD_QACC_L_H_128_IP, MASK_ESP_LD_QACC_L_H_128_IP)
DECLARE_INSN(esp_ld_qacc_l_l_128_ip, MATCH_ESP_LD_QACC_L_L_128_IP, MASK_ESP_LD_QACC_L_L_128_IP)
DECLARE_INSN(esp_ld_ua_state_ip, MATCH_ESP_LD_UA_STATE_IP, MASK_ESP_LD_UA_STATE_IP)
DECLARE_INSN(esp_ld_xacc_ip, MATCH_ESP_LD_XACC_IP, MASK_ESP_LD_XACC_IP)
DECLARE_INSN(esp_ldqa_s16_128_ip, MATCH_ESP_LDQA_S16_128_IP, MASK_ESP_LDQA_S16_128_IP)
DECLARE_INSN(esp_ldqa_s16_128_xp, MATCH_ESP_LDQA_S16_128_XP, MASK_ESP_LDQA_S16_128_XP)
DECLARE_INSN(esp_ldqa_s8_128_ip, MATCH_ESP_LDQA_S8_128_IP, MASK_ESP_LDQA_S8_128_IP)
DECLARE_INSN(esp_ldqa_s8_128_xp, MATCH_ESP_LDQA_S8_128_XP, MASK_ESP_LDQA_S8_128_XP)
DECLARE_INSN(esp_ldqa_u16_128_ip, MATCH_ESP_LDQA_U16_128_IP, MASK_ESP_LDQA_U16_128_IP)
DECLARE_INSN(esp_ldqa_u16_128_xp, MATCH_ESP_LDQA_U16_128_XP, MASK_ESP_LDQA_U16_128_XP)
DECLARE_INSN(esp_ldqa_u8_128_ip, MATCH_ESP_LDQA_U8_128_IP, MASK_ESP_LDQA_U8_128_IP)
DECLARE_INSN(esp_ldqa_u8_128_xp, MATCH_ESP_LDQA_U8_128_XP, MASK_ESP_LDQA_U8_128_XP)
DECLARE_INSN(esp_ldxq_32, MATCH_ESP_LDXQ_32, MASK_ESP_LDXQ_32)
...
DECLARE_INSN(esp_max_s16_a, MATCH_ESP_MAX_S16_A, MASK_ESP_MAX_S16_A)
DECLARE_INSN(esp_max_s32_a, MATCH_ESP_MAX_S32_A, MASK_ESP_MAX_S32_A)
DECLARE_INSN(esp_max_s8_a, MATCH_ESP_MAX_S8_A, MASK_ESP_MAX_S8_A)
DECLARE_INSN(esp_max_u16_a, MATCH_ESP_MAX_U16_A, MASK_ESP_MAX_U16_A)
DECLARE_INSN(esp_max_u32_a, MATCH_ESP_MAX_U32_A, MASK_ESP_MAX_U32_A)
DECLARE_INSN(esp_max_u8_a, MATCH_ESP_MAX_U8_A, MASK_ESP_MAX_U8_A)
DECLARE_INSN(esp_min_s16_a, MATCH_ESP_MIN_S16_A, MASK_ESP_MIN_S16_A)
DECLARE_INSN(esp_min_s32_a, MATCH_ESP_MIN_S32_A, MASK_ESP_MIN_S32_A)
DECLARE_INSN(esp_min_s8_a, MATCH_ESP_MIN_S8_A, MASK_ESP_MIN_S8_A)
DECLARE_INSN(esp_min_u16_a, MATCH_ESP_MIN_U16_A, MASK_ESP_MIN_U16_A)
DECLARE_INSN(esp_min_u32_a, MATCH_ESP_MIN_U32_A, MASK_ESP_MIN_U32_A)
DECLARE_INSN(esp_min_u8_a, MATCH_ESP_MIN_U8_A, MASK_ESP_MIN_U8_A)
DECLARE_INSN(esp_mov_s16_qacc, MATCH_ESP_MOV_S16_QACC, MASK_ESP_MOV_S16_QACC)
DECLARE_INSN(esp_mov_s8_qacc, MATCH_ESP_MOV_S8_QACC, MASK_ESP_MOV_S8_QACC)
DECLARE_INSN(esp_mov_u16_qacc, MATCH_ESP_MOV_U16_QACC, MASK_ESP_MOV_U16_QACC)
DECLARE_INSN(esp_mov_u8_qacc, MATCH_ESP_MOV_U8_QACC, MASK_ESP_MOV_U8_QACC)
DECLARE_INSN(esp_movi_16_a, MATCH_ESP_MOVI_16_A, MASK_ESP_MOVI_16_A)
DECLARE_INSN(esp_movi_16_q, MATCH_ESP_MOVI_16_Q, MASK_ESP_MOVI_16_Q)
DECLARE_INSN(esp_movi_32_a, MATCH_ESP_MOVI_32_A, MASK_ESP_MOVI_32_A)
DECLARE_INSN(esp_movi_32_q, MATCH_ESP_MOVI_32_Q, MASK_ESP_MOVI_32_Q)
DECLARE_INSN(esp_movi_8_a, MATCH_ESP_MOVI_8_A, MASK_ESP_MOVI_8_A)
DECLARE_INSN(esp_movi_8_q, MATCH_ESP_MOVI_8_Q, MASK_ESP_MOVI_8_Q)
DECLARE_INSN(esp_movx_r_cfg, MATCH_ESP_MOVX_R_CFG, MASK_ESP_MOVX_R_CFG)
DECLARE_INSN(esp_movx_r_fft_bit_width, MATCH_ESP_MOVX_R_FFT_BIT_WIDTH, MASK_ESP_MOVX_R_FFT_BIT_WIDTH)
DECLARE_INSN(esp_movx_r_perf, MATCH_ESP_MOVX_R_PERF, MASK_ESP_MOVX_R_PERF)
DECLARE_INSN(esp_movx_r_sar, MATCH_ESP_MOVX_R_SAR, MASK_ESP_MOVX_R_SAR)
DECLARE_INSN(esp_movx_r_sar_bytes, MATCH_ESP_MOVX_R_SAR_BYTES, MASK_ESP_MOVX_R_SAR_BYTES)
DECLARE_INSN(esp_movx_r_xacc_h, MATCH_ESP_MOVX_R_XACC_H, MASK_ESP_MOVX_R_XACC_H)
DECLARE_INSN(esp_movx_r_xacc_l, MATCH_ESP_MOVX_R_XACC_L, MASK_ESP_MOVX_R_XACC_L)
DECLARE_INSN(esp_movx_w_cfg, MATCH_ESP_MOVX_W_CFG, MASK_ESP_MOVX_W_CFG)
DECLARE_INSN(esp_movx_w_fft_bit_width, MATCH_ESP_MOVX_W_FFT_BIT_WIDTH, MASK_ESP_MOVX_W_FFT_BIT_WIDTH)
DECLARE_INSN(esp_movx_w_perf, MATCH_ESP_MOVX_W_PERF, MASK_ESP_MOVX_W_PERF)
DECLARE_INSN(esp_movx_w_sar, MATCH_ESP_MOVX_W_SAR, MASK_ESP_MOVX_W_SAR)
DECLARE_INSN(esp_movx_w_sar_bytes, MATCH_ESP_MOVX_W_SAR_BYTES, MASK_ESP_MOVX_W_SAR_BYTES)
DECLARE_INSN(esp_movx_w_xacc_h, MATCH_ESP_MOVX_W_XACC_H, MASK_ESP_MOVX_W_XACC_H)
DECLARE_INSN(esp_movx_w_xacc_l, MATCH_ESP_MOVX_W_XACC_L, MASK_ESP_MOVX_W_XACC_L)
DECLARE_INSN(esp_notq, MATCH_ESP_NOTQ, MASK_ESP_NOTQ)
DECLARE_INSN(esp_orq, MATCH_ESP_ORQ, MASK_ESP_ORQ)
DECLARE_INSN(esp_sat, MATCH_ESP_SAT, MASK_ESP_SAT)
DECLARE_INSN(esp_slci_2q, MATCH_ESP_SLCI_2Q, MASK_ESP_SLCI_2Q)
DECLARE_INSN(esp_slcxxp_2q, MATCH_ESP_SLCXXP_2Q, MASK_ESP_SLCXXP_2Q)
DECLARE_INSN(esp_src_q, MATCH_ESP_SRC_Q, MASK_ESP_SRC_Q)
DECLARE_INSN(esp_src_q_ld_ip, MATCH_ESP_SRC_Q_LD_IP, MASK_ESP_SRC_Q_LD_IP)
DECLARE_INSN(esp_src_q_ld_xp, MATCH_ESP_SRC_Q_LD_XP, MASK_ESP_SRC_Q_LD_XP)
DECLARE_INSN(esp_src_q_qup, MATCH_ESP_SRC_Q_QUP, MASK_ESP_SRC_Q_QUP)
DECLARE_INSN(esp_srci_2q, MATCH_ESP_SRCI_2Q, MASK_ESP_SRCI_2Q)
DECLARE_INSN(esp_srcmb_s16_q_qacc, MATCH_ESP_SRCMB_S16_Q_QACC, MASK_ESP_SRCMB_S16_Q_QACC)
DECLARE_INSN(esp_srcmb_s16_qacc, MATCH_ESP_SRCMB_S16_QACC, MASK_ESP_SRCMB_S16_QACC)
DECLARE_INSN(esp_srcmb_s8_q_qacc, MATCH_ESP_SRCMB_S8_Q_QACC, MASK_ESP_SRCMB_S8_Q_QACC)
DECLARE_INSN(esp_srcmb_s8_qacc, MATCH_ESP_SRCMB_S8_QACC, MASK_ESP_SRCMB_S8_QACC)
DECLARE_INSN(esp_srcmb_u16_q_qacc, MATCH_ESP_SRCMB_U16_Q_QACC, MASK_ESP_SRCMB_U16_Q_QACC)
DECLARE_INSN(esp_srcmb_u16_qacc, MATCH_ESP_SRCMB_U16_QACC, MASK_ESP_SRCMB_U16_QACC)
DECLARE_INSN(esp_srcmb_u8_q_qacc, MATCH_ESP_SRCMB_U8_Q_QACC, MASK_ESP_SRCMB_U8_Q_QACC)
DECLARE_INSN(esp_srcmb_u8_qacc, MATCH_ESP_SRCMB_U8_QACC, MASK_ESP_SRCMB_U8_QACC)
DECLARE_INSN(esp_srcq_128_st_incp, MATCH_ESP_SRCQ_128_ST_INCP, MASK_ESP_SRCQ_128_ST_INCP)
DECLARE_INSN(esp_srcxxp_2q, MATCH_ESP_SRCXXP_2Q, MASK_ESP_SRCXXP_2Q)
DECLARE_INSN(esp_srs_s_xacc, MATCH_ESP_SRS_S_XACC, MASK_ESP_SRS_S_XACC)
DECLARE_INSN(esp_srs_u_xacc, MATCH_ESP_SRS_U_XACC, MASK_ESP_SRS_U_XACC)
DECLARE_INSN(esp_st_qacc_h_h_128_ip, MATCH_ESP_ST_QACC_H_H_128_IP, MASK_ESP_ST_QACC_H_H_128_IP)
DECLARE_INSN(esp_st_qacc_h_l_128_ip, MATCH_ESP_ST_QACC_H_L_128_IP, MASK_ESP_ST_QACC_H_L_128_IP)
DECLARE_INSN(esp_st_qacc_l_h_128_ip, MATCH_ESP_ST_QACC_L_H_128_IP, MASK_ESP_ST_QACC_L_H_128_IP)
DECLARE_INSN(esp_st_qacc_l_l_128_ip, MATCH_ESP_ST_QACC_L_L_128_IP, MASK_ESP_ST_QACC_L_L_128_IP)
DECLARE_INSN(esp_st_s_xacc_ip, MATCH_ESP_ST_S_XACC_IP, MASK_ESP_ST_S_XACC_IP)
DECLARE_INSN(esp_st_u_xacc_ip, MATCH_ESP_ST_U_XACC_IP, MASK_ESP_ST_U_XACC_IP)
DECLARE_INSN(esp_st_ua_state_ip, MATCH_ESP_ST_UA_STATE_IP, MASK_ESP_ST_UA_STATE_IP)
DECLARE_INSN(esp_stxq_32, MATCH_ESP_STXQ_32, MASK_ESP_STXQ_32)
DECLARE_INSN(esp_subx2, MATCH_ESP_SUBX2, MASK_ESP_SUBX2)
DECLARE_INSN(esp_subx4, MATCH_ESP_SUBX4, MASK_ESP_SUBX4)
DECLARE_INSN(esp_vabs_16, MATCH_ESP_VABS_16, MASK_ESP_VABS_16)
DECLARE_INSN(esp_vabs_32, MATCH_ESP_VABS_32, MASK_ESP_VABS_32)
DECLARE_INSN(esp_vabs_8, MATCH_ESP_VABS_8, MASK_ESP_VABS_8)
DECLARE_INSN(esp_vadd_s16, MATCH_ESP_VADD_S16, MASK_ESP_VADD_S16)
DECLARE_INSN(esp_vadd_s16_ld_incp, MATCH_ESP_VADD_S16_LD_INCP, MASK_ESP_VADD_S16_LD_INCP)
DECLARE_INSN(esp_vadd_s16_st_incp, MATCH_ESP_VADD_S16_ST_INCP, MASK_ESP_VADD_S16_ST_INCP)
DECLARE_INSN(esp_vadd_s32, MATCH_ESP_VADD_S32, MASK_ESP_VADD_S32)
DECLARE_INSN(esp_vadd_s32_ld_incp, MATCH_ESP_VADD_S32_LD_INCP, MASK_ESP_VADD_S32_LD_INCP)
DECLARE_INSN(esp_vadd_s32_st_incp, MATCH_ESP_VADD_S32_ST_INCP, MASK_ESP_VADD_S32_ST_INCP)
DECLARE_INSN(esp_vadd_s8, MATCH_ESP_VADD_S8, MASK_ESP_VADD_S8)
DECLARE_INSN(esp_vadd_s8_ld_incp, MATCH_ESP_VADD_S8_LD_INCP, MASK_ESP_VADD_S8_LD_INCP)
DECLARE_INSN(esp_vadd_s8_st_incp, MATCH_ESP_VADD_S8_ST_INCP, MASK_ESP_VADD_S8_ST_INCP)
DECLARE_INSN(esp_vadd_u16, MATCH_ESP_VADD_U16, MASK_ESP_VADD_U16)
DECLARE_INSN(esp_vadd_u16_ld_incp, MATCH_ESP_VADD_U16_LD_INCP, MASK_ESP_VADD_U16_LD_INCP)
DECLARE_INSN(esp_vadd_u16_st_incp, MATCH_ESP_VADD_U16_ST_INCP, MASK_ESP_VADD_U16_ST_INCP)
DECLARE_INSN(esp_vadd_u32, MATCH_ESP_VADD_U32, MASK_ESP_VADD_U32)
DECLARE_INSN(esp_vadd_u32_ld_incp, MATCH_ESP_VADD_U32_LD_INCP, MASK_ESP_VADD_U32_LD_INCP)
DECLARE_INSN(esp_vadd_u32_st_incp, MATCH_ESP_VADD_U32_ST_INCP, MASK_ESP_VADD_U32_ST_INCP)
DECLARE_INSN(esp_vadd_u8, MATCH_ESP_VADD_U8, MASK_ESP_VADD_U8)
DECLARE_INSN(esp_vadd_u8_ld_incp, MATCH_ESP_VADD_U8_LD_INCP, MASK_ESP_VADD_U8_LD_INCP)
DECLARE_INSN(esp_vadd_u8_st_incp, MATCH_ESP_VADD_U8_ST_INCP, MASK_ESP_VADD_U8_ST_INCP)
DECLARE_INSN(esp_vclamp_s16, MATCH_ESP_VCLAMP_S16, MASK_ESP_VCLAMP_S16)
DECLARE_INSN(esp_vcmp_eq_s16, MATCH_ESP_VCMP_EQ_S16, MASK_ESP_VCMP_EQ_S16)
DECLARE_INSN(esp_vcmp_eq_s32, MATCH_ESP_VCMP_EQ_S32, MASK_ESP_VCMP_EQ_S32)
DECLARE_INSN(esp_vcmp_eq_s8, MATCH_ESP_VCMP_EQ_S8, MASK_ESP_VCMP_EQ_S8)
DECLARE_INSN(esp_vcmp_eq_u16, MATCH_ESP_VCMP_EQ_U16, MASK_ESP_VCMP_EQ_U16)
DECLARE_INSN(esp_vcmp_eq_u32, MATCH_ESP_VCMP_EQ_U32, MASK_ESP_VCMP_EQ_U32)
DECLARE_INSN(esp_vcmp_eq_u8, MATCH_ESP_VCMP_EQ_U8, MASK_ESP_VCMP_EQ_U8)
DECLARE_INSN(esp_vcmp_gt_s16, MATCH_ESP_VCMP_GT_S16, MASK_ESP_VCMP_GT_S16)
DECLARE_INSN(esp_vcmp_gt_s32, MATCH_ESP_VCMP_GT_S32, MASK_ESP_VCMP_GT_S32)
DECLARE_INSN(esp_vcmp_gt_s8, MATCH_ESP_VCMP_GT_S8, MASK_ESP_VCMP_GT_S8)
DECLARE_INSN(esp_vcmp_gt_u16, MATCH_ESP_VCMP_GT_U16, MASK_ESP_VCMP_GT_U16)
DECLARE_INSN(esp_vcmp_gt_u32, MATCH_ESP_VCMP_GT_U32, MASK_ESP_VCMP_GT_U32)
DECLARE_INSN(esp_vcmp_gt_u8, MATCH_ESP_VCMP_GT_U8, MASK_ESP_VCMP_GT_U8)
DECLARE_INSN(esp_vcmp_lt_s16, MATCH_ESP_VCMP_LT_S16, MASK_ESP_VCMP_LT_S16)
DECLARE_INSN(esp_vcmp_lt_s32, MATCH_ESP_VCMP_LT_S32, MASK_ESP_VCMP_LT_S32)
DECLARE_INSN(esp_vcmp_lt_s8, MATCH_ESP_VCMP_LT_S8, MASK_ESP_VCMP_LT_S8)
DECLARE_INSN(esp_vcmp_lt_u16, MATCH_ESP_VCMP_LT_U16, MASK_ESP_VCMP_LT_U16)
DECLARE_INSN(esp_vcmp_lt_u32, MATCH_ESP_VCMP_LT_U32, MASK_ESP_VCMP_LT_U32)
DECLARE_INSN(esp_vcmp_lt_u8, MATCH_ESP_VCMP_LT_U8, MASK_ESP_VCMP_LT_U8)
DECLARE_INSN(esp_vcmulas_s16_qacc_h, MATCH_ESP_VCMULAS_S16_QACC_H, MASK_ESP_VCMULAS_S16_QACC_H)
DECLARE_INSN(esp_vcmulas_s16_qacc_h_ld_ip, MATCH_ESP_VCMULAS_S16_QACC_H_LD_IP, MASK_ESP_VCMULAS_S16_QACC_H_LD_IP)
DECLARE_INSN(esp_vcmulas_s16_qacc_h_ld_xp, MATCH_ESP_VCMULAS_S16_QACC_H_LD_XP, MASK_ESP_VCMULAS_S16_QACC_H_LD_XP)
DECLARE_INSN(esp_vcmulas_s16_qacc_l, MATCH_ESP_VCMULAS_S16_QACC_L, MASK_ESP_VCMULAS_S16_QACC_L)
DECLARE_INSN(esp_vcmulas_s16_qacc_l_ld_ip, MATCH_ESP_VCMULAS_S16_QACC_L_LD_IP, MASK_ESP_VCMULAS_S16_QACC_L_LD_IP)
DECLARE_INSN(esp_vcmulas_s16_qacc_l_ld_xp, MATCH_ESP_VCMULAS_S16_QACC_L_LD_XP, MASK_ESP_VCMULAS_S16_QACC_L_LD_XP)
DECLARE_INSN(esp_vcmulas_s8_qacc_h, MATCH_ESP_VCMULAS_S8_QACC_H, MASK_ESP_VCMULAS_S8_QACC_H)
DECLARE_INSN(esp_vcmulas_s8_qacc_h_ld_ip, MATCH_ESP_VCMULAS_S8_QACC_H_LD_IP, MASK_ESP_VCMULAS_S8_QACC_H_LD_IP)
DECLARE_INSN(esp_vcmulas_s8_qacc_h_ld_xp, MATCH_ESP_VCMULAS_S8_QACC_H_LD_XP, MASK_ESP_VCMULAS_S8_QACC_H_LD_XP)
DECLARE_INSN(esp_vcmulas_s8_qacc_l, MATCH_ESP_VCMULAS_S8_QACC_L, MASK_ESP_VCMULAS_S8_QACC_L)
DECLARE_INSN(esp_vcmulas_s8_qacc_l_ld_ip, MATCH_ESP_VCMULAS_S8_QACC_L_LD_IP, MASK_ESP_VCMULAS_S8_QACC_L_LD_IP)
DECLARE_INSN(esp_vcmulas_s8_qacc_l_ld_xp, MATCH_ESP_VCMULAS_S8_QACC_L_LD_XP, MASK_ESP_VCMULAS_S8_QACC_L_LD_XP)
DECLARE_INSN(esp_vext_s16, MATCH_ESP_VEXT_S16, MASK_ESP_VEXT_S16)
DECLARE_INSN(esp_vext_s8, MATCH_ESP_VEXT_S8, MASK_ESP_VEXT_S8)
DECLARE_INSN(esp_vext_u16, MATCH_ESP_VEXT_U16, MASK_ESP_VEXT_U16)
DECLARE_INSN(esp_vext_u8, MATCH_ESP_VEXT_U8, MASK_ESP_VEXT_U8)
DECLARE_INSN(esp_vld_128_ip, MATCH_ESP_VLD_128_IP, MASK_ESP_VLD_128_IP)
DECLARE_INSN(esp_vld_128_xp, MATCH_ESP_VLD_128_XP, MASK_ESP_VLD_128_XP)
DECLARE_INSN(esp_vld_h_64_ip, MATCH_ESP_VLD_H_64_IP, MASK_ESP_VLD_H_64_IP)
DECLARE_INSN(esp_vld_h_64_xp, MATCH_ESP_VLD_H_64_XP, MASK_ESP_VLD_H_64_XP)
DECLARE_INSN(esp_vld_l_64_ip, MATCH_ESP_VLD_L_64_IP, MASK_ESP_VLD_L_64_IP)
DECLARE_INSN(esp_vld_l_64_xp, MATCH_ESP_VLD_L_64_XP, MASK_ESP_VLD_L_64_XP)
DECLARE_INSN(esp_vldbc_16_ip, MATCH_ESP_VLDBC_16_IP, MASK_ESP_VLDBC_16_IP)
DECLARE_INSN(esp_vldbc_16_xp, MATCH_ESP_VLDBC_16_XP, MASK_ESP_VLDBC_16_XP)
DECLARE_INSN(esp_vldbc_32_ip, MATCH_ESP_VLDBC_32_IP, MASK_ESP_VLDBC_32_IP)
DECLARE_INSN(esp_vldbc_32_xp, MATCH_ESP_VLDBC_32_XP, MASK_ESP_VLDBC_32_XP)
DECLARE_INSN(esp_vldbc_8_ip, MATCH_ESP_VLDBC_8_IP, MASK_ESP_VLDBC_8_IP)
DECLARE_INSN(esp_vldbc_8_xp, MATCH_ESP_VLDBC_8_XP, MASK_ESP_VLDBC_8_XP)
DECLARE_INSN(esp_vldext_s16_ip, MATCH_ESP_VLDEXT_S16_IP, MASK_ESP_VLDEXT_S16_IP)
DECLARE_INSN(esp_vldext_s16_xp, MATCH_ESP_VLDEXT_S16_XP, MASK_ESP_VLDEXT_S16_XP)
DECLARE_INSN(esp_vldext_s8_ip, MATCH_ESP_VLDEXT_S8_IP, MASK_ESP_VLDEXT_S8_IP)
DECLARE_INSN(esp_vldext_s8_xp, MATCH_ESP_VLDEXT_S8_XP, MASK_ESP_VLDEXT_S8_XP)
DECLARE_INSN(esp_vldext_u16_ip, MATCH_ESP_VLDEXT_U16_IP, MASK_ESP_VLDEXT_U16_IP)
DECLARE_INSN(esp_vldext_u16_xp, MATCH_ESP_VLDEXT_U16_XP, MASK_ESP_VLDEXT_U16_XP)
DECLARE_INSN(esp_vldext_u8_ip, MATCH_ESP_VLDEXT_U8_IP, MASK_ESP_VLDEXT_U8_IP)
DECLARE_INSN(esp_vldext_u8_xp, MATCH_ESP_VLDEXT_U8_XP, MASK_ESP_VLDEXT_U8_XP)
DECLARE_INSN(esp_vldhbc_16_incp, MATCH_ESP_VLDHBC_16_INCP, MASK_ESP_VLDHBC_16_INCP)
DECLARE_INSN(esp_vmax_s16, MATCH_ESP_VMAX_S16, MASK_ESP_VMAX_S16)
DECLARE_INSN(esp_vmax_s16_ld_incp, MATCH_ESP_VMAX_S16_LD_INCP, MASK_ESP_VMAX_S16_LD_INCP)
DECLARE_INSN(esp_vmax_s16_st_incp, MATCH_ESP_VMAX_S16_ST_INCP, MASK_ESP_VMAX_S16_ST_INCP)
DECLARE_INSN(esp_vmax_s32, MATCH_ESP_VMAX_S32, MASK_ESP_VMAX_S32)
DECLARE_INSN(esp_vmax_s32_ld_incp, MATCH_ESP_VMAX_S32_LD_INCP, MASK_ESP_VMAX_S32_LD_INCP)
DECLARE_INSN(esp_vmax_s32_st_incp, MATCH_ESP_VMAX_S32_ST_INCP, MASK_ESP_VMAX_S32_ST_INCP)
DECLARE_INSN(esp_vmax_s8, MATCH_ESP_VMAX_S8, MASK_ESP_VMAX_S8)
DECLARE_INSN(esp_vmax_s8_ld_incp, MATCH_ESP_VMAX_S8_LD_INCP, MASK_ESP_VMAX_S8_LD_INCP)
DECLARE_INSN(esp_vmax_s8_st_incp, MATCH_ESP_VMAX_S8_ST_INCP, MASK_ESP_VMAX_S8_ST_INCP)
DECLARE_INSN(esp_vmax_u16, MATCH_ESP_VMAX_U16, MASK_ESP_VMAX_U16)
DECLARE_INSN(esp_vmax_u16_ld_incp, MATCH_ESP_VMAX_U16_LD_INCP, MASK_ESP_VMAX_U16_LD_INCP)
DECLARE_INSN(esp_vmax_u16_st_incp, MATCH_ESP_VMAX_U16_ST_INCP, MASK_ESP_VMAX_U16_ST_INCP)
DECLARE_INSN(esp_vmax_u32, MATCH_ESP_VMAX_U32, MASK_ESP_VMAX_U32)
DECLARE_INSN(esp_vmax_u32_ld_incp, MATCH_ESP_VMAX_U32_LD_INCP, MASK_ESP_VMAX_U32_LD_INCP)
DECLARE_INSN(esp_vmax_u32_st_incp, MATCH_ESP_VMAX_U32_ST_INCP, MASK_ESP_VMAX_U32_ST_INCP)
DECLARE_INSN(esp_vmax_u8, MATCH_ESP_VMAX_U8, MASK_ESP_VMAX_U8)
DECLARE_INSN(esp_vmax_u8_ld_incp, MATCH_ESP_VMAX_U8_LD_INCP, MASK_ESP_VMAX_U8_LD_INCP)
DECLARE_INSN(esp_vmax_u8_st_incp, MATCH_ESP_VMAX_U8_ST_INCP, MASK_ESP_VMAX_U8_ST_INCP)
DECLARE_INSN(esp_vmin_s16, MATCH_ESP_VMIN_S16, MASK_ESP_VMIN_S16)
DECLARE_INSN(esp_vmin_s16_ld_incp, MATCH_ESP_VMIN_S16_LD_INCP, MASK_ESP_VMIN_S16_LD_INCP)
DECLARE_INSN(esp_vmin_s16_st_incp, MATCH_ESP_VMIN_S16_ST_INCP, MASK_ESP_VMIN_S16_ST_INCP)
DECLARE_INSN(esp_vmin_s32, MATCH_ESP_VMIN_S32, MASK_ESP_VMIN_S32)
DECLARE_INSN(esp_vmin_s32_ld_incp, MATCH_ESP_VMIN_S32_LD_INCP, MASK_ESP_VMIN_S32_LD_INCP)
DECLARE_INSN(esp_vmin_s32_st_incp, MATCH_ESP_VMIN_S32_ST_INCP, MASK_ESP_VMIN_S32_ST_INCP)
DECLARE_INSN(esp_vmin_s8, MATCH_ESP_VMIN_S8, MASK_ESP_VMIN_S8)
DECLARE_INSN(esp_vmin_s8_ld_incp, MATCH_ESP_VMIN_S8_LD_INCP, MASK_ESP_VMIN_S8_LD_INCP)
DECLARE_INSN(esp_vmin_s8_st_incp, MATCH_ESP_VMIN_S8_ST_INCP, MASK_ESP_VMIN_S8_ST_INCP)
DECLARE_INSN(esp_vmin_u16, MATCH_ESP_VMIN_U16, MASK_ESP_VMIN_U16)
DECLARE_INSN(esp_vmin_u16_ld_incp, MATCH_ESP_VMIN_U16_LD_INCP, MASK_ESP_VMIN_U16_LD_INCP)
DECLARE_INSN(esp_vmin_u16_st_incp, MATCH_ESP_VMIN_U16_ST_INCP, MASK_ESP_VMIN_U16_ST_INCP)
DECLARE_INSN(esp_vmin_u32, MATCH_ESP_VMIN_U32, MASK_ESP_VMIN_U32)
DECLARE_INSN(esp_vmin_u32_ld_incp, MATCH_ESP_VMIN_U32_LD_INCP, MASK_ESP_VMIN_U32_LD_INCP)
DECLARE_INSN(esp_vmin_u32_st_incp, MATCH_ESP_VMIN_U32_ST_INCP, MASK_ESP_VMIN_U32_ST_INCP)
DECLARE_INSN(esp_vmin_u8, MATCH_ESP_VMIN_U8, MASK_ESP_VMIN_U8)
DECLARE_INSN(esp_vmin_u8_ld_incp, MATCH_ESP_VMIN_U8_LD_INCP, MASK_ESP_VMIN_U8_LD_INCP)
DECLARE_INSN(esp_vmin_u8_st_incp, MATCH_ESP_VMIN_U8_ST_INCP, MASK_ESP_VMIN_U8_ST_INCP)
DECLARE_INSN(esp_vmul_s16, MATCH_ESP_VMUL_S16, MASK_ESP_VMUL_S16)
DECLARE_INSN(esp_vmul_s16_ld_incp, MATCH_ESP_VMUL_S16_LD_INCP, MASK_ESP_VMUL_S16_LD_INCP)
DECLARE_INSN(esp_vmul_s16_s8xs8, MATCH_ESP_VMUL_S16_S8XS8, MASK_ESP_VMUL_S16_S8XS8)
DECLARE_INSN(esp_vmul_s16_st_incp, MATCH_ESP_VMUL_S16_ST_INCP, MASK_ESP_VMUL_S16_ST_INCP)
DECLARE_INSN(esp_vmul_s32_s16xs16, MATCH_ESP_VMUL_S32_S16XS16, MASK_ESP_VMUL_S32_S16XS16)
DECLARE_INSN(esp_vmul_s8, MATCH_ESP_VMUL_S8, MASK_ESP_VMUL_S8)
DECLARE_INSN(esp_vmul_s8_ld_incp, MATCH_ESP_VMUL_S8_LD_INCP, MASK_ESP_VMUL_S8_LD_INCP)
DECLARE_INSN(esp_vmul_s8_st_incp, MATCH_ESP_VMUL_S8_ST_INCP, MASK_ESP_VMUL_S8_ST_INCP)
DECLARE_INSN(esp_vmul_u16, MATCH_ESP_VMUL_U16, MASK_ESP_VMUL_U16)
DECLARE_INSN(esp_vmul_u16_ld_incp, MATCH_ESP_VMUL_U16_LD_INCP, MASK_ESP_VMUL_U16_LD_INCP)
DECLARE_INSN(esp_vmul_u16_st_incp, MATCH_ESP_VMUL_U16_ST_INCP, MASK_ESP_VMUL_U16_ST_INCP)
DECLARE_INSN(esp_vmul_u8, MATCH_ESP_VMUL_U8, MASK_ESP_VMUL_U8)
DECLARE_INSN(esp_vmul_u8_ld_incp, MATCH_ESP_VMUL_U8_LD_INCP, MASK_ESP_VMUL_U8_LD_INCP)
DECLARE_INSN(esp_vmul_u8_st_incp, MATCH_ESP_VMUL_U8_ST_INCP, MASK_ESP_VMUL_U8_ST_INCP)
DECLARE_INSN(esp_vmulas_s16_qacc, MATCH_ESP_VMULAS_S16_QACC, MASK_ESP_VMULAS_S16_QACC)
DECLARE_INSN(esp_vmulas_s16_qacc_ld_ip, MATCH_ESP_VMULAS_S16_QACC_LD_IP, MASK_ESP_VMULAS_S16_QACC_LD_IP)
DECLARE_INSN(esp_vmulas_s16_qacc_ld_xp, MATCH_ESP_VMULAS_S16_QACC_LD_XP, MASK_ESP_VMULAS_S16_QACC_LD_XP)
DECLARE_INSN(esp_vmulas_s16_qacc_ldbc_incp, MATCH_ESP_VMULAS_S16_QACC_LDBC_INCP, MASK_ESP_VMULAS_S16_QACC_LDBC_INCP)
DECLARE_INSN(esp_vmulas_s16_qacc_st_ip, MATCH_ESP_VMULAS_S16_QACC_ST_IP, MASK_ESP_VMULAS_S16_QACC_ST_IP)
DECLARE_INSN(esp_vmulas_s16_qacc_st_xp, MATCH_ESP_VMULAS_S16_QACC_ST_XP, MASK_ESP_VMULAS_S16_QACC_ST_XP)
DECLARE_INSN(esp_vmulas_s16_xacc, MATCH_ESP_VMULAS_S16_XACC, MASK_ESP_VMULAS_S16_XACC)
DECLARE_INSN(esp_vmulas_s16_xacc_ld_ip, MATCH_ESP_VMULAS_S16_XACC_LD_IP, MASK_ESP_VMULAS_S16_XACC_LD_IP)
DECLARE_INSN(esp_vmulas_s16_xacc_ld_xp, MATCH_ESP_VMULAS_S16_XACC_LD_XP, MASK_ESP_VMULAS_S16_XACC_LD_XP)
DECLARE_INSN(esp_vmulas_s16_xacc_st_ip, MATCH_ESP_VMULAS_S16_XACC_ST_IP, MASK_ESP_VMULAS_S16_XACC_ST_IP)
DECLARE_INSN(esp_vmulas_s16_xacc_st_xp, MATCH_ESP_VMULAS_S16_XACC_ST_XP, MASK_ESP_VMULAS_S16_XACC_ST_XP)
DECLARE_INSN(esp_vmulas_s8_qacc, MATCH_ESP_VMULAS_S8_QACC, MASK_ESP_VMULAS_S8_QACC)
DECLARE_INSN(esp_vmulas_s8_qacc_ld_ip, MATCH_ESP_VMULAS_S8_QACC_LD_IP, MASK_ESP_VMULAS_S8_QACC_LD_IP)
DECLARE_INSN(esp_vmulas_s8_qacc_ld_xp, MATCH_ESP_VMULAS_S8_QACC_LD_XP, MASK_ESP_VMULAS_S8_QACC_LD_XP)
DECLARE_INSN(esp_vmulas_s8_qacc_ldbc_incp, MATCH_ESP_VMULAS_S8_QACC_LDBC_INCP, MASK_ESP_VMULAS_S8_QACC_LDBC_INCP)
DECLARE_INSN(esp_vmulas_s8_qacc_st_ip, MATCH_ESP_VMULAS_S8_QACC_ST_IP, MASK_ESP_VMULAS_S8_QACC_ST_IP)
DECLARE_INSN(esp_vmulas_s8_qacc_st_xp, MATCH_ESP_VMULAS_S8_QACC_ST_XP, MASK_ESP_VMULAS_S8_QACC_ST_XP)
DECLARE_INSN(esp_vmulas_s8_xacc, MATCH_ESP_VMULAS_S8_XACC, MASK_ESP_VMULAS_S8_XACC)
DECLARE_INSN(esp_vmulas_s8_xacc_ld_ip, MATCH_ESP_VMULAS_S8_XACC_LD_IP, MASK_ESP_VMULAS_S8_XACC_LD_IP)
DECLARE_INSN(esp_vmulas_s8_xacc_ld_xp, MATCH_ESP_VMULAS_S8_XACC_LD_XP, MASK_ESP_VMULAS_S8_XACC_LD_XP)
DECLARE_INSN(esp_vmulas_s8_xacc_st_ip, MATCH_ESP_VMULAS_S8_XACC_ST_IP, MASK_ESP_VMULAS_S8_XACC_ST_IP)
DECLARE_INSN(esp_vmulas_s8_xacc_st_xp, MATCH_ESP_VMULAS_S8_XACC_ST_XP, MASK_ESP_VMULAS_S8_XACC_ST_XP)
DECLARE_INSN(esp_vmulas_u16_qacc, MATCH_ESP_VMULAS_U16_QACC, MASK_ESP_VMULAS_U16_QACC)
DECLARE_INSN(esp_vmulas_u16_qacc_ld_ip, MATCH_ESP_VMULAS_U16_QACC_LD_IP, MASK_ESP_VMULAS_U16_QACC_LD_IP)
DECLARE_INSN(esp_vmulas_u16_qacc_ld_xp, MATCH_ESP_VMULAS_U16_QACC_LD_XP, MASK_ESP_VMULAS_U16_QACC_LD_XP)
DECLARE_INSN(esp_vmulas_u16_qacc_ldbc_incp, MATCH_ESP_VMULAS_U16_QACC_LDBC_INCP, MASK_ESP_VMULAS_U16_QACC_LDBC_INCP)
DECLARE_INSN(esp_vmulas_u16_qacc_st_ip, MATCH_ESP_VMULAS_U16_QACC_ST_IP, MASK_ESP_VMULAS_U16_QACC_ST_IP)
DECLARE_INSN(esp_vmulas_u16_qacc_st_xp, MATCH_ESP_VMULAS_U16_QACC_ST_XP, MASK_ESP_VMULAS_U16_QACC_ST_XP)
DECLARE_INSN(esp_vmulas_u16_xacc, MATCH_ESP_VMULAS_U16_XACC, MASK_ESP_VMULAS_U16_XACC)
DECLARE_INSN(esp_vmulas_u16_xacc_ld_ip, MATCH_ESP_VMULAS_U16_XACC_LD_IP, MASK_ESP_VMULAS_U16_XACC_LD_IP)
DECLARE_INSN(esp_vmulas_u16_xacc_ld_xp, MATCH_ESP_VMULAS_U16_XACC_LD_XP, MASK_ESP_VMULAS_U16_XACC_LD_XP)
DECLARE_INSN(esp_vmulas_u16_xacc_st_ip, MATCH_ESP_VMULAS_U16_XACC_ST_IP, MASK_ESP_VMULAS_U16_XACC_ST_IP)
DECLARE_INSN(esp_vmulas_u16_xacc_st_xp, MATCH_ESP_VMULAS_U16_XACC_ST_XP, MASK_ESP_VMULAS_U16_XACC_ST_XP)
DECLARE_INSN(esp_vmulas_u8_qacc, MATCH_ESP_VMULAS_U8_QACC, MASK_ESP_VMULAS_U8_QACC)
DECLARE_INSN(esp_vmulas_u8_qacc_ld_ip, MATCH_ESP_VMULAS_U8_QACC_LD_IP, MASK_ESP_VMULAS_U8_QACC_LD_IP)
DECLARE_INSN(esp_vmulas_u8_qacc_ld_xp, MATCH_ESP_VMULAS_U8_QACC_LD_XP, MASK_ESP_VMULAS_U8_QACC_LD_XP)
DECLARE_INSN(esp_vmulas_u8_qacc_ldbc_incp, MATCH_ESP_VMULAS_U8_QACC_LDBC_INCP, MASK_ESP_VMULAS_U8_QACC_LDBC_INCP)
DECLARE_INSN(esp_vmulas_u8_qacc_st_ip, MATCH_ESP_VMULAS_U8_QACC_ST_IP, MASK_ESP_VMULAS_U8_QACC_ST_IP)
DECLARE_INSN(esp_vmulas_u8_qacc_st_xp, MATCH_ESP_VMULAS_U8_QACC_ST_XP, MASK_ESP_VMULAS_U8_QACC_ST_XP)
DECLARE_INSN(esp_vmulas_u8_xacc, MATCH_ESP_VMULAS_U8_XACC, MASK_ESP_VMULAS_U8_XACC)
DECLARE_INSN(esp_vmulas_u8_xacc_ld_ip, MATCH_ESP_VMULAS_U8_XACC_LD_IP, MASK_ESP_VMULAS_U8_XACC_LD_IP)
DECLARE_INSN(esp_vmulas_u8_xacc_ld_xp, MATCH_ESP_VMULAS_U8_XACC_LD_XP, MASK_ESP_VMULAS_U8_XACC_LD_XP)
DECLARE_INSN(esp_vmulas_u8_xacc_st_ip, MATCH_ESP_VMULAS_U8_XACC_ST_IP, MASK_ESP_VMULAS_U8_XACC_ST_IP)
DECLARE_INSN(esp_vmulas_u8_xacc_st_xp, MATCH_ESP_VMULAS_U8_XACC_ST_XP, MASK_ESP_VMULAS_U8_XACC_ST_XP)
DECLARE_INSN(esp_vprelu_s16, MATCH_ESP_VPRELU_S16, MASK_ESP_VPRELU_S16)
DECLARE_INSN(esp_vprelu_s8, MATCH_ESP_VPRELU_S8, MASK_ESP_VPRELU_S8)
DECLARE_INSN(esp_vrelu_s16, MATCH_ESP_VRELU_S16, MASK_ESP_VRELU_S16)
DECLARE_INSN(esp_vrelu_s8, MATCH_ESP_VRELU_S8, MASK_ESP_VRELU_S8)
DECLARE_INSN(esp_vsadds_s16, MATCH_ESP_VSADDS_S16, MASK_ESP_VSADDS_S16)
DECLARE_INSN(esp_vsadds_s8, MATCH_ESP_VSADDS_S8, MASK_ESP_VSADDS_S8)
DECLARE_INSN(esp_vsadds_u16, MATCH_ESP_VSADDS_U16, MASK_ESP_VSADDS_U16)
DECLARE_INSN(esp_vsadds_u8, MATCH_ESP_VSADDS_U8, MASK_ESP_VSADDS_U8)
DECLARE_INSN(esp_vsat_s16, MATCH_ESP_VSAT_S16, MASK_ESP_VSAT_S16)
DECLARE_INSN(esp_vsat_s32, MATCH_ESP_VSAT_S32, MASK_ESP_VSAT_S32)
DECLARE_INSN(esp_vsat_s8, MATCH_ESP_VSAT_S8, MASK_ESP_VSAT_S8)
DECLARE_INSN(esp_vsat_u16, MATCH_ESP_VSAT_U16, MASK_ESP_VSAT_U16)
DECLARE_INSN(esp_vsat_u32, MATCH_ESP_VSAT_U32, MASK_ESP_VSAT_U32)
DECLARE_INSN(esp_vsat_u8, MATCH_ESP_VSAT_U8, MASK_ESP_VSAT_U8)
DECLARE_INSN(esp_vsl_32, MATCH_ESP_VSL_32, MASK_ESP_VSL_32)
DECLARE_INSN(esp_vsld_16, MATCH_ESP_VSLD_16, MASK_ESP_VSLD_16)
DECLARE_INSN(esp_vsld_32, MATCH_ESP_VSLD_32, MASK_ESP_VSLD_32)
DECLARE_INSN(esp_vsld_8, MATCH_ESP_VSLD_8, MASK_ESP_VSLD_8)
DECLARE_INSN(esp_vsmulas_s16_qacc, MATCH_ESP_VSMULAS_S16_QACC, MASK_ESP_VSMULAS_S16_QACC)
DECLARE_INSN(esp_vsmulas_s16_qacc_ld_incp, MATCH_ESP_VSMULAS_S16_QACC_LD_INCP, MASK_ESP_VSMULAS_S16_QACC_LD_INCP)
DECLARE_INSN(esp_vsmulas_s8_qacc, MATCH_ESP_VSMULAS_S8_QACC, MASK_ESP_VSMULAS_S8_QACC)
DECLARE_INSN(esp_vsmulas_s8_qacc_ld_incp, MATCH_ESP_VSMULAS_S8_QACC_LD_INCP, MASK_ESP_VSMULAS_S8_QACC_LD_INCP)
DECLARE_INSN(esp_vsmulas_u16_qacc, MATCH_ESP_VSMULAS_U16_QACC, MASK_ESP_VSMULAS_U16_QACC)
DECLARE_INSN(esp_vsmulas_u16_qacc_ld_incp, MATCH_ESP_VSMULAS_U16_QACC_LD_INCP, MASK_ESP_VSMULAS_U16_QACC_LD_INCP)
DECLARE_INSN(esp_vsmulas_u8_qacc, MATCH_ESP_VSMULAS_U8_QACC, MASK_ESP_VSMULAS_U8_QACC)
DECLARE_INSN(esp_vsmulas_u8_qacc_ld_incp, MATCH_ESP_VSMULAS_U8_QACC_LD_INCP, MASK_ESP_VSMULAS_U8_QACC_LD_INCP)
DECLARE_INSN(esp_vsr_s32, MATCH_ESP_VSR_S32, MASK_ESP_VSR_S32)
DECLARE_INSN(esp_vsr_u32, MATCH_ESP_VSR_U32, MASK_ESP_VSR_U32)
DECLARE_INSN(esp_vsrd_16, MATCH_ESP_VSRD_16, MASK_ESP_VSRD_16)
DECLARE_INSN(esp_vsrd_32, MATCH_ESP_VSRD_32, MASK_ESP_VSRD_32)
DECLARE_INSN(esp_vsrd_8, MATCH_ESP_VSRD_8, MASK_ESP_VSRD_8)
DECLARE_INSN(esp_vssubs_s16, MATCH_ESP_VSSUBS_S16, MASK_ESP_VSSUBS_S16)
DECLARE_INSN(esp_vssubs_s8, MATCH_ESP_VSSUBS_S8, MASK_ESP_VSSUBS_S8)
DECLARE_INSN(esp_vssubs_u16, MATCH_ESP_VSSUBS_U16, MASK_ESP_VSSUBS_U16)
DECLARE_INSN(esp_vssubs_u8, MATCH_ESP_VSSUBS_U8, MASK_ESP_VSSUBS_U8)
DECLARE_INSN(esp_vst_128_ip, MATCH_ESP_VST_128_IP, MASK_ESP_VST_128_IP)
DECLARE_INSN(esp_vst_128_xp, MATCH_ESP_VST_128_XP, MASK_ESP_VST_128_XP)
DECLARE_INSN(esp_vst_h_64_ip, MATCH_ESP_VST_H_64_IP, MASK_ESP_VST_H_64_IP)
DECLARE_INSN(esp_vst_h_64_xp, MATCH_ESP_VST_H_64_XP, MASK_ESP_VST_H_64_XP)
DECLARE_INSN(esp_vst_l_64_ip, MATCH_ESP_VST_L_64_IP, MASK_ESP_VST_L_64_IP)
DECLARE_INSN(esp_vst_l_64_xp, MATCH_ESP_VST_L_64_XP, MASK_ESP_VST_L_64_XP)
DECLARE_INSN(esp_vsub_s16, MATCH_ESP_VSUB_S16, MASK_ESP_VSUB_S16)
DECLARE_INSN(esp_vsub_s16_ld_incp, MATCH_ESP_VSUB_S16_LD_INCP, MASK_ESP_VSUB_S16_LD_INCP)
DECLARE_INSN(esp_vsub_s16_st_incp, MATCH_ESP_VSUB_S16_ST_INCP, MASK_ESP_VSUB_S16_ST_INCP)
DECLARE_INSN(esp_vsub_s32, MATCH_ESP_VSUB_S32, MASK_ESP_VSUB_S32)
DECLARE_INSN(esp_vsub_s32_ld_incp, MATCH_ESP_VSUB_S32_LD_INCP, MASK_ESP_VSUB_S32_LD_INCP)
DECLARE_INSN(esp_vsub_s32_st_incp, MATCH_ESP_VSUB_S32_ST_INCP, MASK_ESP_VSUB_S32_ST_INCP)
DECLARE_INSN(esp_vsub_s8, MATCH_ESP_VSUB_S8, MASK_ESP_VSUB_S8)
DECLARE_INSN(esp_vsub_s8_ld_incp, MATCH_ESP_VSUB_S8_LD_INCP, MASK_ESP_VSUB_S8_LD_INCP)
DECLARE_INSN(esp_vsub_s8_st_incp, MATCH_ESP_VSUB_S8_ST_INCP, MASK_ESP_VSUB_S8_ST_INCP)
DECLARE_INSN(esp_vsub_u16, MATCH_ESP_VSUB_U16, MASK_ESP_VSUB_U16)
DECLARE_INSN(esp_vsub_u16_ld_incp, MATCH_ESP_VSUB_U16_LD_INCP, MASK_ESP_VSUB_U16_LD_INCP)
DECLARE_INSN(esp_vsub_u16_st_incp, MATCH_ESP_VSUB_U16_ST_INCP, MASK_ESP_VSUB_U16_ST_INCP)
DECLARE_INSN(esp_vsub_u32, MATCH_ESP_VSUB_U32, MASK_ESP_VSUB_U32)
DECLARE_INSN(esp_vsub_u32_ld_incp, MATCH_ESP_VSUB_U32_LD_INCP, MASK_ESP_VSUB_U32_LD_INCP)
DECLARE_INSN(esp_vsub_u32_st_incp, MATCH_ESP_VSUB_U32_ST_INCP, MASK_ESP_VSUB_U32_ST_INCP)
DECLARE_INSN(esp_vsub_u8, MATCH_ESP_VSUB_U8, MASK_ESP_VSUB_U8)
DECLARE_INSN(esp_vsub_u8_ld_incp, MATCH_ESP_VSUB_U8_LD_INCP, MASK_ESP_VSUB_U8_LD_INCP)
DECLARE_INSN(esp_vsub_u8_st_incp, MATCH_ESP_VSUB_U8_ST_INCP, MASK_ESP_VSUB_U8_ST_INCP)
DECLARE_INSN(esp_vunzip_16, MATCH_ESP_VUNZIP_16, MASK_ESP_VUNZIP_16)
DECLARE_INSN(esp_vunzip_32, MATCH_ESP_VUNZIP_32, MASK_ESP_VUNZIP_32)
DECLARE_INSN(esp_vunzip_8, MATCH_ESP_VUNZIP_8, MASK_ESP_VUNZIP_8)
DECLARE_INSN(esp_vunzipt_16, MATCH_ESP_VUNZIPT_16, MASK_ESP_VUNZIPT_16)
DECLARE_INSN(esp_vunzipt_8, MATCH_ESP_VUNZIPT_8, MASK_ESP_VUNZIPT_8)
DECLARE_INSN(esp_vzip_16, MATCH_ESP_VZIP_16, MASK_ESP_VZIP_16)
DECLARE_INSN(esp_vzip_32, MATCH_ESP_VZIP_32, MASK_ESP_VZIP_32)
DECLARE_INSN(esp_vzip_8, MATCH_ESP_VZIP_8, MASK_ESP_VZIP_8)
DECLARE_INSN(esp_vzipt_16, MATCH_ESP_VZIPT_16, MASK_ESP_VZIPT_16)
DECLARE_INSN(esp_vzipt_8, MATCH_ESP_VZIPT_8, MASK_ESP_VZIPT_8)
DECLARE_INSN(esp_xorq, MATCH_ESP_XORQ, MASK_ESP_XORQ)
DECLARE_INSN(esp_zero_q, MATCH_ESP_ZERO_Q, MASK_ESP_ZERO_Q)
DECLARE_INSN(esp_zero_qacc, MATCH_ESP_ZERO_QACC, MASK_ESP_ZERO_QACC)
DECLARE_INSN(esp_zero_xacc, MATCH_ESP_ZERO_XACC, MASK_ESP_ZERO_XACC)
/* XESPLOOP instructions. */
DECLARE_INSN(esp_lp_count, MATCH_ESP_LP_COUNT, MASK_ESP_LP_COUNT)
DECLARE_INSN(esp_lp_counti, MATCH_ESP_LP_COUNTI, MASK_ESP_LP_COUNTI)
DECLARE_INSN(esp_lp_endi, MATCH_ESP_LP_ENDI, MASK_ESP_LP_ENDI)
DECLARE_INSN(esp_lp_setup, MATCH_ESP_LP_SETUP, MASK_ESP_LP_SETUP)
DECLARE_INSN(esp_lp_setupi, MATCH_ESP_LP_SETUPI, MASK_ESP_LP_SETUPI)
DECLARE_INSN(esp_lp_starti, MATCH_ESP_LP_STARTI, MASK_ESP_LP_STARTI)
/* XESPDSP instructions. */
DECLARE_INSN(esp_abs, MATCH_ESP_ABS, MASK_ESP_ABS)
DECLARE_INSN(esp_clzs, MATCH_ESP_CLZS, MASK_ESP_CLZS)
DECLARE_INSN(esp_flw_ip, MATCH_ESP_FLW_IP, MASK_ESP_FLW_IP)
DECLARE_INSN(esp_flw_xp, MATCH_ESP_FLW_XP, MASK_ESP_FLW_XP)
DECLARE_INSN(esp_fsw_ip, MATCH_ESP_FSW_IP, MASK_ESP_FSW_IP)
DECLARE_INSN(esp_fsw_xp, MATCH_ESP_FSW_XP, MASK_ESP_FSW_XP)
DECLARE_INSN(esp_lb_ip, MATCH_ESP_LB_IP, MASK_ESP_LB_IP)
DECLARE_INSN(esp_lb_xp, MATCH_ESP_LB_XP, MASK_ESP_LB_XP)
DECLARE_INSN(esp_lbu_ip, MATCH_ESP_LBU_IP, MASK_ESP_LBU_IP)
DECLARE_INSN(esp_lbu_xp, MATCH_ESP_LBU_XP, MASK_ESP_LBU_XP)
DECLARE_INSN(esp_lh_ip, MATCH_ESP_LH_IP, MASK_ESP_LH_IP)
DECLARE_INSN(esp_lh_xp, MATCH_ESP_LH_XP, MASK_ESP_LH_XP)
DECLARE_INSN(esp_lhu_ip, MATCH_ESP_LHU_IP, MASK_ESP_LHU_IP)
DECLARE_INSN(esp_lhu_xp, MATCH_ESP_LHU_XP, MASK_ESP_LHU_XP)
DECLARE_INSN(esp_lw_ip, MATCH_ESP_LW_IP, MASK_ESP_LW_IP)
DECLARE_INSN(esp_lw_xp, MATCH_ESP_LW_XP, MASK_ESP_LW_XP)
DECLARE_INSN(esp_macs16ix2, MATCH_ESP_MACS16IX2, MASK_ESP_MACS16IX2)
DECLARE_INSN(esp_macs16x1_ld, MATCH_ESP_MACS16X1_LD, MASK_ESP_MACS16X1_LD)
DECLARE_INSN(esp_macs16x2, MATCH_ESP_MACS16X2, MASK_ESP_MACS16X2)
DECLARE_INSN(esp_macs16x2_ld, MATCH_ESP_MACS16X2_LD, MASK_ESP_MACS16X2_LD)
DECLARE_INSN(esp_macs16x2_st, MATCH_ESP_MACS16X2_ST, MASK_ESP_MACS16X2_ST)
DECLARE_INSN(esp_macs32, MATCH_ESP_MACS32, MASK_ESP_MACS32)
DECLARE_INSN(esp_macs32_ld, MATCH_ESP_MACS32_LD, MASK_ESP_MACS32_LD)
DECLARE_INSN(esp_macs32_st, MATCH_ESP_MACS32_ST, MASK_ESP_MACS32_ST)
DECLARE_INSN(esp_macs32i, MATCH_ESP_MACS32I, MASK_ESP_MACS32I)
DECLARE_INSN(esp_max, MATCH_ESP_MAX, MASK_ESP_MAX)
DECLARE_INSN(esp_min, MATCH_ESP_MIN, MASK_ESP_MIN)
DECLARE_INSN(esp_movr_xacc, MATCH_ESP_MOVR_XACC, MASK_ESP_MOVR_XACC)
DECLARE_INSN(esp_movw_xacc, MATCH_ESP_MOVW_XACC, MASK_ESP_MOVW_XACC)
DECLARE_INSN(esp_msus16ix2, MATCH_ESP_MSUS16IX2, MASK_ESP_MSUS16IX2)
DECLARE_INSN(esp_msus16x1_ld, MATCH_ESP_MSUS16X1_LD, MASK_ESP_MSUS16X1_LD)
DECLARE_INSN(esp_msus16x2, MATCH_ESP_MSUS16X2, MASK_ESP_MSUS16X2)
DECLARE_INSN(esp_msus16x2_ld, MATCH_ESP_MSUS16X2_LD, MASK_ESP_MSUS16X2_LD)
DECLARE_INSN(esp_msus16x2_st, MATCH_ESP_MSUS16X2_ST, MASK_ESP_MSUS16X2_ST)
DECLARE_INSN(esp_msus32, MATCH_ESP_MSUS32, MASK_ESP_MSUS32)
DECLARE_INSN(esp_msus32_ld, MATCH_ESP_MSUS32_LD, MASK_ESP_MSUS32_LD)
DECLARE_INSN(esp_msus32_st, MATCH_ESP_MSUS32_ST, MASK_ESP_MSUS32_ST)
DECLARE_INSN(esp_msus32i, MATCH_ESP_MSUS32I, MASK_ESP_MSUS32I)
DECLARE_INSN(esp_muls16ix2, MATCH_ESP_MULS16IX2, MASK_ESP_MULS16IX2)
DECLARE_INSN(esp_muls16x2, MATCH_ESP_MULS16X2, MASK_ESP_MULS16X2)
DECLARE_INSN(esp_muls32, MATCH_ESP_MULS32, MASK_ESP_MULS32)
DECLARE_INSN(esp_muls32i, MATCH_ESP_MULS32I, MASK_ESP_MULS32I)
DECLARE_INSN(esp_sat, MATCH_ESP_SAT, MASK_ESP_SAT)
DECLARE_INSN(esp_sb_ip, MATCH_ESP_SB_IP, MASK_ESP_SB_IP)
DECLARE_INSN(esp_sb_xp, MATCH_ESP_SB_XP, MASK_ESP_SB_XP)
DECLARE_INSN(esp_sh_ip, MATCH_ESP_SH_IP, MASK_ESP_SH_IP)
DECLARE_INSN(esp_sh_xp, MATCH_ESP_SH_XP, MASK_ESP_SH_XP)
DECLARE_INSN(esp_shl, MATCH_ESP_SHL, MASK_ESP_SHL)
DECLARE_INSN(esp_shr, MATCH_ESP_SHR, MASK_ESP_SHR)
DECLARE_INSN(esp_sw_ip, MATCH_ESP_SW_IP, MASK_ESP_SW_IP)
DECLARE_INSN(esp_sw_xp, MATCH_ESP_SW_XP, MASK_ESP_SW_XP)
#else /* RISCV_XESPV2P1  */
DECLARE_INSN(esp_abs, MATCH_ESP_ABS, MASK_ESP_ABS)
DECLARE_INSN(esp_addx2, MATCH_ESP_ADDX2, MASK_ESP_ADDX2)
DECLARE_INSN(esp_addx4, MATCH_ESP_ADDX4, MASK_ESP_ADDX4)
...
DECLARE_INSN(esp_vsat_u32, MATCH_ESP_VSAT_U32, MASK_ESP_VSAT_U32)
DECLARE_INSN(esp_vsat_u8, MATCH_ESP_VSAT_U8, MASK_ESP_VSAT_U8)
DECLARE_INSN(esp_vsl_s32, MATCH_ESP_VSL_S32, MASK_ESP_VSL_S32)
DECLARE_INSN(esp_vsl_u32, MATCH_ESP_VSL_U32, MASK_ESP_VSL_U32)
DECLARE_INSN(esp_vsld_16, MATCH_ESP_VSLD_16, MASK_ESP_VSLD_16)
DECLARE_INSN(esp_vsld_32, MATCH_ESP_VSLD_32, MASK_ESP_VSLD_32)
DECLARE_INSN(esp_vsld_8, MATCH_ESP_VSLD_8, MASK_ESP_VSLD_8)
DECLARE_INSN(esp_vsmulas_s16_qacc, MATCH_ESP_VSMULAS_S16_QACC, MASK_ESP_VSMULAS_S16_QACC)
