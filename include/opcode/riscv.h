...
#define VALID_ESPPIE_RD_1(x) (EXTRACT_ESPPIE_RD_1(ENCODE_ESPPIE_RD_1(x)) == (x))
...
#define VALID_ESPPIE_RS2_1(x) (EXTRACT_ESPPIE_RS2_1(ENCODE_ESPPIE_RS2_1(x)) == (x))
...
#define OP_MASK_ESPPIE_RD_1   0x1f
#define OP_SH_ESPPIE_RD_1     20
#define OP_MASK_ESPPIE_RS2_0  0x1f
#define OP_SH_ESPPIE_RS2_0    7
