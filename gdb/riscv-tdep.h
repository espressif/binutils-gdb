...
#undef DECLARE_CSR
  ...
  RISCV_FIRST_ESPPIE_REGNUM,
  RISCV_LAST_ESPPIE_REGNUM = RISCV_FIRST_ESPPIE_REGNUM + 16,

  RISCV_LAST_REGNUM = RISCV_LAST_ESPPIE_REGNUM
};
...
enum
{
  ...
  RISCV_DWARF_FIRST_ESPPIE = 128,
  RISCV_DWARF_LAST_ESPPIE = 143,
