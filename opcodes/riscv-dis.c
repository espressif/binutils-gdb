	...
	case 'G':
	  switch (*++oparg)
		...
		case '1':	/* Gd1 */
		  /* 3rd bit of rd/rs1/rs2 absent in PIE instructions and assumed to be '1' */
		  print (info->stream, dis_style_register, "%s",
			 riscv_gpr_names[EXTRACT_ESPPIE_RD_1 (l) | 1 << 3]);
		  break;	/* Gd1 */
		default:	/* Gd[.] */
		  goto undefined_modifier;
		}
		...
		case '0':	/* Gs0 */
		  /* 3rd bit of rd/rs1/rs2 absent in PIE instructions and assumed to be '1' */
		  print (info->stream, dis_style_register, "%s",
			 riscv_gpr_names[EXTRACT_ESPPIE_RS1_0 (l) | 1 << 3]);
		  break;	/* Gs0 */
		default:	/* Gs[.] */
		  goto undefined_modifier;
		}
		...
		case '0':	/* Gt0 */
		  /* 3rd bit of rd/rs1/rs2 absent in PIE instructions and assumed to be '1' */
		  print (info->stream, dis_style_register, "%s",
			 riscv_gpr_names[EXTRACT_ESPPIE_RS2_0 (l) | 1 << 3]);
		  break;	/* Gt0 */
		case '1':	/* Gt1 */
		  /* 3rd bit of rd/rs1/rs2 absent in PIE instructions and assumed to be '1' */
		  print (info->stream, dis_style_register, "%s",
			 riscv_gpr_names[EXTRACT_ESPPIE_RS2_1 (l) | 1 << 3]);
		  break;	/* Gt1 */
		default:	/* Gt[.] */
		  goto undefined_modifier;
		}
