...
INSTR_T esp32ulp_wr_mem_stlh (int low_hi, int dst_reg, int src_reg,
			      Expr_Node * offset);
INSTR_T esp32ulp_wr_mem_st32 (int dst_reg, int src_reg, Expr_Node * offset,
			      Expr_Node * label);
INSTR_T esp32ulp_wr_mem_sti32 (int dst_reg, int src_reg, Expr_Node * label);
INSTR_T esp32ulp_wr_mem_st_l (int low_hi, int dst_reg, int src_reg,
...
INSTR_T esp32ulp_rd_mem_addr (int lh, int dst_reg, int src_reg,
			      Expr_Node * addr);
...
INSTR_T esp32ulp_cmd_jump_relr (Expr_Node * step, Expr_Node * thresh,
				int cond);
INSTR_T esp32ulp_cmd_jump_rels (Expr_Node * step, Expr_Node * thresh,
				int cond);
INSTR_T esp32ulp_cmd_reg_rd (Expr_Node * addr, Expr_Node * high,
			     Expr_Node * low);
INSTR_T esp32ulp_cmd_reg_wr (Expr_Node * addr, Expr_Node * high,
			     Expr_Node * low, Expr_Node * data);
// I2C operations 
INSTR_T esp32ulp_cmd_i2c_rd (Expr_Node * i2c_addr, Expr_Node * high,
			     Expr_Node * low, Expr_Node * i2c_sel);
INSTR_T esp32ulp_cmd_i2c_wr (Expr_Node * i2c_addr, Expr_Node * high,
			     Expr_Node * low, Expr_Node * i2c_sel,
			     Expr_Node * data);
