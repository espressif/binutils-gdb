		  ...
		  switch (*++oparg)
			...
			case '4':
			  switch (*++oparg)
			    ...
			    case '2': used_bits |= ENCODE_ESP_OFFSET_256_16_2 (-1U); break;	/* Xeo842 */
			    case '3': used_bits |= ENCODE_ESP_OFFSET_256_16_3 (-1U); break;	/* Xeo843 */
			    case '4': used_bits |= ENCODE_ESP_OFFSET_256_16_4 (-1U); break;	/* Xeo844 */
			    default:	/* Xeo84[.] */
			      goto unknown_validate_operand;
			    }
			  break;
		...
		case 'v':
		  switch (*++oparg)
			...
			case '0':
			  switch (*++oparg)
			    {
			    case '0': used_bits |= ENCODE_ESP_RM_00 (-1U); break;	/* Xevr00 */
			    case '1': used_bits |= ENCODE_ESP_RM_01 (-1U); break;	/* Xevr01 */
			    case '2': used_bits |= ENCODE_ESP_RM_02 (-1U); break;	/* Xevr02 */
			    case '3': used_bits |= ENCODE_ESP_RM_03 (-1U); break;	/* Xevr03 */
			    case '4': used_bits |= ENCODE_ESP_RM_04 (-1U); break;	/* Xevr04 */
			    case '5': used_bits |= ENCODE_ESP_RM_05 (-1U); break;	/* Xevr05 */
			    case '6': used_bits |= ENCODE_ESP_RM_06 (-1U); break;	/* Xevr06 */
			    case '7': used_bits |= ENCODE_ESP_RM_07 (-1U); break;	/* Xevr07 */
			    case '8': used_bits |= ENCODE_ESP_RM_08 (-1U); break;	/* Xevr08 */
			    case '9': used_bits |= ENCODE_ESP_RM_09 (-1U); break;	/* Xevr09 */
			    default:	/* Xevr0[.] */
			      goto unknown_validate_operand;
			    }
			  break;
			case '1':
			  switch (*++oparg)
			    {
			    case '0': used_bits |= ENCODE_ESP_RM_10 (-1U); break;	/* Xevr10 */
			    default:	/* Xevr1[.] */
			      goto unknown_validate_operand;
			    }
			  break;
			...
			case '0':
			  switch (*++oparg)
			    {
			    case '0': used_bits |= ENCODE_ESP_SAT_00 (-1U); break;	/* Xevs00 */
			    case '1': used_bits |= ENCODE_ESP_SAT_01 (-1U); break;	/* Xevs01 */
			    case '2': used_bits |= ENCODE_ESP_SAT_02 (-1U); break;	/* Xevs02 */
			    case '3': used_bits |= ENCODE_ESP_SAT_03 (-1U); break;	/* Xevs03 */
			    case '4': used_bits |= ENCODE_ESP_SAT_04 (-1U); break;	/* Xevs04 */
			    case '5': used_bits |= ENCODE_ESP_SAT_05 (-1U); break;	/* Xevs05 */
			    case '6': used_bits |= ENCODE_ESP_SAT_06 (-1U); break;	/* Xevs06 */
			    case '7': used_bits |= ENCODE_ESP_SAT_07 (-1U); break;	/* Xevs07 */
			    case '8': used_bits |= ENCODE_ESP_SAT_08 (-1U); break;	/* Xevs08 */
			    case '9': used_bits |= ENCODE_ESP_SAT_09 (-1U); break;	/* Xevs09 */
			    default:	/* Xevs0[.] */
			      goto unknown_validate_operand;
			    }
			  break;
			case '1':
			  switch (*++oparg)
			    {
			    case '0': used_bits |= ENCODE_ESP_SAT_10 (-1U); break;	/* Xevs10 */
			    case '1': used_bits |= ENCODE_ESP_SAT_11 (-1U); break;	/* Xevs11 */
			    case '2': used_bits |= ENCODE_ESP_SAT_12 (-1U); break;	/* Xevs12 */
			    case '3': used_bits |= ENCODE_ESP_SAT_13 (-1U); break;	/* Xevs13 */
			    case '4': used_bits |= ENCODE_ESP_SAT_14 (-1U); break;	/* Xevs14 */
			    case '5': used_bits |= ENCODE_ESP_SAT_15 (-1U); break;	/* Xevs15 */
			    case '6': used_bits |= ENCODE_ESP_SAT_16 (-1U); break;	/* Xevs16 */
			    default:	/* Xevs1[.] */
			      goto unknown_validate_operand;
			    }
			  break;
