...
INSTR_T esp32ulp_gen_alui_esp32 (int dst, int src1, Expr_Node * addr,
				 int operation);
...
INSTR_T esp32ulp_cmd_jump_relr_esp32 (Expr_Node * step, Expr_Node * thresh,
				      int cond);
INSTR_T esp32ulp_cmd_jump_rels_esp32 (Expr_Node * step, Expr_Node * thresh,
				      int cond);
INSTR_T esp32ulp_cmd_reg_rd_esp32 (Expr_Node * addr, Expr_Node * high,
				   Expr_Node * low);
INSTR_T esp32ulp_cmd_reg_wr_esp32 (Expr_Node * addr, Expr_Node * high,
				   Expr_Node * low, Expr_Node * data);
INSTR_T esp32ulp_cmd_i2c_rd_esp32 (Expr_Node * i2c_addr, Expr_Node * high,
				   Expr_Node * low, Expr_Node * i2c_sel);
INSTR_T esp32ulp_cmd_i2c_wr_esp32 (Expr_Node * i2c_addr, Expr_Node * high,
				   Expr_Node * low, Expr_Node * i2c_sel,
				   Expr_Node * data);
INSTR_T esp32ulp_rd_mem_addr_esp32 (int lh, int dst_reg, int src_reg,
				    Expr_Node * addr);
...
void md_apply_fix_esp32 (fixS * fixP, valueT * valueP,
