#name: Espressif PMP misalign insert notes
#source: fix-esp-pmp-misalign.s
#as: -march=rv32i -mno-arch-attr
#ld: -m[riscv_choose_ilp32_emul] --fix-esp-pmp-misalign --print-esp-pmp-misalign-fixes
#objdump: -d
#warning: .*\+0\): note: inserted 2 Espressif PMP misalign NOPs\n
#warning: .*\+0x24\): note: inserted 2 Espressif PMP misalign NOPs\n
#warning: .*\+0x40\): note: inserted 2 Espressif PMP misalign NOPs
